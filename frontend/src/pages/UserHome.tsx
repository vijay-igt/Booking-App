...
const UserHome: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-neutral-950 text-white selection:bg-emerald-500/30">
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-4">
                                            <button
                                                ...
                                                className="h-14 px-8 rounded-2xl bg-emerald-500 hover:bg-emerald-400 text-neutral-950 font-bold text-lg flex items-center gap-2 transition-all hover:scale-105 shadow-[0_0_40_rgba(16,185,129,0.3)]"
                                            >
            ...
            {/* Main Content */}
            <main className={cn(
                "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 transition-all duration-500",
                searchQuery ? "pt-28" : "-mt-20"
            )}>

                {!searchQuery && !loadingRecommendations && recommended.length > 0 && (
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                    <div className="flex flex-col gap-4">
                        {searchQuery && (
                            ...
                            >
                                <h2 className="text-3xl font-black italic text-white uppercase tracking-tighter">Search Results</h2>
                                <span className="text-emerald-500 font-bold tracking-widest uppercase text-xs">for "{searchQuery}"</span>
                            </motion.div>
                        )}
